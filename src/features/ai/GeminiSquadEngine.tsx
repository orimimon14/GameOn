                    ...
                    <div className="relative">
                        ...
                        <div className="absolute left-4 bottom-4 flex gap-2">
                            <button 
                                ...
                                className={`px-10 py-4 rounded-2xl font-black italic uppercase transition-all flex items-center gap-3 overflow-hidden group ${loading ? 'bg-gray-500/50 opacity-50 cursor-not-allowed' : 'bg-primary text-white shadow-glow hover:scale-105 hover:shadow-indigo-500/50'}`}
                            >
                                {loading ? (
                                    <>
                            ...
                            {result.tips.map((tip: string, idx: number) => (
                                <div key={idx} className="flex items-center justify-end gap-4 p-4 dark:bg-white/5 bg-black/5 rounded-2xl border border-transparent hover:border-white/10 transition-all">
                                    ...
                                    <div className="w-6 h-6 rounded-full bg-success/20 flex items-center justify-center shrink-0">
                                        <i className="fa-solid fa-check text-success text-[10px]"></i>
                                    </div>
                                </div>
                            ))}
                        </div>
